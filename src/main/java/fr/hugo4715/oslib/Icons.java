...
public class Icons {
	...
	public static String getIconString(AbstractOperatingSystem os) {
		...
		if (os == null || os != null && os.getType() == OperatingSystem.UNKNOWN) {
			...
			fr.hugo4715.oslib.bsd.BSDOperatingSystem bos = (BSDOperatingSystem) os;
